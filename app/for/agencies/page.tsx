      ...
      longGuide={{
        ...
        sections: [
          ...
          },
          {
            ...
            body: [
              "Most agency proposals waste 4–6 pages on 'About Us' content — agency size, office locations, awards, logo soup. Senior buyers ignore all of it. Replace credentials with credibility: three short case studies that mirror the client's situation, each with a specific outcome and a one-line lesson learned. 'For a $40M ARR B2B SaaS in legal tech, we increased pipeline-qualified leads by 73% over 9 months by shifting 60% of paid spend from brand to bottom-funnel demand keywords. Key lesson: brand spend was masking weak bottom-funnel performance.'",
